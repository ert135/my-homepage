...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){let r=new Float32Array(Do),i=new G(0,1,0);return new ia({name:`SphericalGaussianBlur`,defines:{n:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(){return new ia({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new ia({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wo(),fragmentShader:`
	...
	`}var Go=class extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},$l=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},eu=new Ba(-1,1,1,-1,0,1),tu=new class extends Ir{constructor(){super(),this.setAttribute(`position`,new Y([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new Y([0,2,0,0,2,0],2))}},nu=class{constructor(e){this._mesh=new X(tu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,eu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},ru=class extends $l{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ia?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ta.clone(e.uniforms),this.material=new ia({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new nu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},iu=class extends $l{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},au=class extends $l{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},ou=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new W);this._width=n.width,this._height=n.height,t=new nn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:O}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ru(Ql),this.copyPass.material.blending=0,this.timer=new Ja}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}iu!==void 0&&(r instanceof iu?n=!0:r instanceof au&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new W);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},su=class extends $l{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new J}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},cu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new J(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},lu=class e extends $l{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new W(256,256):new W(e.x,e.y),this.clearColor=new J(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new nn(i,a,{type:O}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new nn(i,a,{type:O});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new nn(i,a,{type:O});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=cu;this.highPassUniforms=ta.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ia({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1),new G(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=ta.clone(Ql.uniforms),this.blendMaterial=new ia({uniforms:this.copyUniforms,vertexShader:Ql.vertexShader,fragmentShader:Ql.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new J,this._oldClearAlpha=1,this._basic=new qr,this._fsQuad=new nu(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new W(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new ia({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new W(.5,.5)},direction:{value:new W(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}};lu.BlurDirectionX=new W(1,0),lu.BlurDirectionY=new W(0,1);var uu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},du=class extends $l{constructor(){super(),this.isOutputPass=!0,this.uniforms=ta.clone(uu.uniforms),this.material=new aa({name:uu.name,uniforms:this.uniforms,vertexShader:uu.vertexShader,fragmentShader:uu.fragmentShader}),this._fsQuad=new nu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},fu=`varying vec2 vUv;
...
}`,mu=class extends Pn{constructor({color:e=3800852,scale:t=1,health:n=3,deadBodyLifetime:r=5,fadeDuration:i=1.5}={}){super(),this.maxHealth=n,this.health=n,this.isAlive=!0,this.collisionRadius=.2,this.deadTime=0,this.deadBodyLifetime=r,this.fadeDuration=i,this.baseColor=new J(e),this.material=new qr({color:this.baseColor,toneMapped:!1}),this.createHead(),this.createBody(),this.createArms(),this.createLegs(),this.scale.setScalar(t)}createHead(){let e=new Wi(.11,0);this.head=new X(e,this.material),this.head.position.y=.9,this.add(this.head)}createBody(){let e=new Vi(.045,.045,.42,5);this.body=new X(e,this.material),this.body.position.y=.61,this.add(this.body)}createArms(){let e=new Vi(.035,.035,.55,5);this.arms=new X(e,this.material),this.arms.rotation.z=Math.PI/2,this.arms.position.y=.7,this.add(this.arms)}createLegs(){let e=new Vi(.04,.04,.42,5);this.leftLeg=new X(e,this.material),this.leftLeg.position.set(-.06,.22,0),this.leftLeg.rotation.z=-.28,this.add(this.leftLeg),this.rightLeg=new X(e,this.material),this.rightLeg.position.set(.06,.22,0),this.rightLeg.rotation.z=.28,this.add(this.rightLeg)}setColor(e){this.material.color.set(e)}takeDamage(e=1){this.isAlive&&(this.health=Math.max(0,this.health-e),this.updateHealthColor(),this.health===0&&this.die())}updateHealthColor(){let e=.4+this.health/this.maxHealth*.6;this.material.color.copy(this.baseColor).multiplyScalar(e)}die(){this.isAlive=!1,this.deadTime=0,this.rotation.z=Math.PI/2,this.position.y+=.15,this.material.color.copy(this.baseColor).multiplyScalar(.15),this.material.transparent=!0,this.material.opacity=1}updateDeadBody(e){if(this.isAlive)return!1;this.deadTime+=e;let t=this.deadBodyLifetime-this.fadeDuration;if(this.deadTime>=t){let e=(this.deadTime-t)/this.fadeDuration;this.material.opacity=1-U.clamp(e,0,1)}return this.deadTime>=this.deadBodyLifetime}dispose(){let e=new Set,t=new Set;this.traverse(n=>{if(n.geometry&&e.add(n.geometry),n.material){let e=Array.isArray(n.material)?n.material:[n.material];for(let n of e)t.add(n)}});for(let t of e)t.dispose();for(let e of t)e.dispose()}},hu=class extends Pn{constructor({soldierCount:e=12,spawn:t=new G,target:n=new G,color:r=3800852,getTerrainHeight:i=()=>0,maxSpeed:a=.9,maxForce:o=.65,getObstacles:s=()=>[]}={}){super(),this.getObstacles=s,this.target=n.clone(),this.getTerrainHeight=i,this.maxSpeed=a,this.maxForce=o,this.soldiers=[],this.initialStrength=e,this.reinforcementRequested=!1,this.reinforcementLane=t.z,this.createSoldiers(e,t,r)}getLivingSoldiers(){return this.soldiers.filter(e=>e.isAlive)}createSoldiers(e,t,n){let r=Math.min(4,e),i=Math.ceil(e/r),a=.75,o=this.target.clone().sub(t).setY(0).normalize();for(let s=0;s<e;s++){let e=Math.floor(s/r),c=s%r,l=new G((e-(i-1)/2)*a,0,(c-(r-1)/2)*a),u=new mu({color:n,scale:.8,fadeDuration:30}),d=t.x+l.x,f=t.z+l.z,p=this.getTerrainHeight(d,f);u.position.set(d,p+.02,f),u.steering={formationOffset:l,velocity:o.clone().multiplyScalar(this.maxSpeed*.5).add(new G(U.randFloatSpread(.1),0,U.randFloatSpread(.1)))},this.soldiers.push(u),this.add(u)}}update(e){this.cleanupDeadSoldiers(e);let t=this.getLivingSoldiers();if(t.length===0)return;let n=this.getCentre(t),r=this.getAverageVelocity(t);for(let i of t){let a=this.target.clone().add(i.steering.formationOffset),o=this.arrive(i,a,7),s=this.separate(i,t),c=this.arrive(i,n,3),l=this.align(i,r),u=this.avoidObstacles(i),d=new G;d.addScaledVector(o,1),d.addScaledVector(s,1.8),d.addScaledVector(c,.35),d.addScaledVector(l,.7),d.addScaledVector(u,3),d.clampLength(0,this.maxForce);let f=i.steering.velocity;f.addScaledVector(d,e),f.y=0,f.clampLength(0,this.maxSpeed),i.position.addScaledVector(f,e),i.position.y=this.getTerrainHeight(i.position.x,i.position.z)+.02,f.lengthSq()>1e-4&&(i.rotation.y=Math.atan2(f.x,f.z))}}arrive(e,t,n){let r=new G(t.x-e.position.x,0,t.z-e.position.z),i=r.length();if(i<.01)return e.steering.velocity.clone().multiplyScalar(-1);let a=this.maxSpeed*Math.min(i/n,1);return r.setLength(a),r.sub(e.steering.velocity).clampLength(0,this.maxForce)}separate(e,t){let n=new G,r=0;for(let i of t){if(i===e)continue;let t=new G(e.position.x-i.position.x,0,e.position.z-i.position.z),a=t.length();a>0&&a<.9&&(t.normalize().divideScalar(a),n.add(t),r++)}return r===0?n:(n.divideScalar(r),n.setLength(this.maxSpeed).sub(e.steering.velocity).clampLength(0,this.maxForce))}align(e,t){return t.clone().sub(e.steering.velocity).clampLength(0,this.maxForce)}getCentre(e){let t=new G;for(let n of e)t.add(n.position);return t.divideScalar(e.length)}getAverageVelocity(e){let t=new G;for(let n of e)t.add(n.steering.velocity);return t.divideScalar(e.length)}getStrength(){return this.getLivingSoldiers().length}getStrengthPercentage(){return this.initialStrength===0?0:this.getStrength()/this.initialStrength}needsReinforcement(){return!this.reinforcementRequested&&this.getStrengthPercentage()<.5}markReinforcementRequested(){this.reinforcementRequested=!0}cleanupDeadSoldiers(e){for(let t=this.soldiers.length-1;t>=0;t--){let n=this.soldiers[t];n.isAlive||n.updateDeadBody(e)&&(this.remove(n),n.dispose(),this.soldiers.splice(t,1))}}avoidObstacles(e){let t=this.getObstacles(),n=new G,r=e.steering.velocity;if(r.lengthSq()<.001)return n;let i=e.getWorldPosition(new G),a=r.clone().setY(0).normalize(),o=i.clone().addScaledVector(a,1.2);for(let r of t){if(r===e)continue;let t=r.getWorldPosition(new G),i=r.collisionRadius??.25,s=e.collisionRadius+i+.35,c=new G(o.x-t.x,0,o.z-t.z),l=c.length();if(l>=s)continue;c.lengthSq()<.001&&c.set(-a.z,0,a.x),c.normalize();let u=1-l/s;n.addScaledVector(c,u)}return n.lengthSq()===0?n:n.normalize().multiplyScalar(this.maxSpeed).sub(r).clampLength(0,this.maxForce)}},gu=class extends Pn{constructor({platoonCount:e=3,soldiersPerPlatoon:t=12,spawnX:n=-18,platoonSpacing:r=8,color:i=3800852,getTerrainHeight:a=()=>0,maxReinforcements:o=6,getObstacles:s=()=>[]}={}){super(),this.getObstacles=s,this.color=i,this.soldiersPerPlatoon=t,this.spawnX=n,this.getTerrainHeight=a,this.maxReinforcements=o,this.reinforcementCount=0,this.platoons=[];for(let t=0;t<e;t++){let n=(t-(e-1)/2)*r;this.createPlatoon({spawnLane:n,targetZ:n*.6})}}createPlatoon({spawnLane:e,targetZ:t}){let n=new hu({soldierCount:this.soldiersPerPlatoon,spawn:new G(this.spawnX+U.randFloat(-10,5),0,e),target:new G(0,0,t+U.randFloat(-10,10)),color:this.color,getTerrainHeight:this.getTerrainHeight,getObstacles:this.getObstacles});return this.platoons.push(n),this.add(n),n}update(e){let t=[...this.platoons];for(let n of t)n.update(e);for(let e of t)e.needsReinforcement()&&this.requestReinforcement(e)}requestReinforcement(e){if(e.markReinforcementRequested(),this.reinforcementCount>=this.maxReinforcements)return;this.reinforcementCount++;let t=e.reinforcementLane+U.randFloatSpread(2),n=e.target.z+U.randFloatSpread(3);this.createPlatoon({spawnLane:t,targetZ:n})}getLivingSoldiers(){return this.platoons.flatMap(e=>e.getLivingSoldiers())}},_u=class extends Pn{constructor({size:e=100,segments:t=120,terrainColor:n=398374,wireframeColor:r=3194069}={}){super(),this.size=e,this.segments=t,this.craters=[],this.createGeometry(),this.createTerrain(n),this.createWireframe(r)}createGeometry(){this.geometry=new Gi(this.size,this.size,this.segments,this.segments),this.geometry.rotateX(-Math.PI/2);let e=this.geometry.attributes.position;for(let t=0;t<e.count;t+=1){let n=e.getX(t),r=e.getZ(t);e.setY(t,this.getHeightAt(n,r))}e.needsUpdate=!0,this.geometry.computeVertexNormals(),this.geometry.computeBoundingBox(),this.geometry.computeBoundingSphere()}getBaseHeightAt(e,t){let n=Math.sqrt(e*e+t*t),r=U.smoothstep(n,4,35);return(Math.sin(e*.35)*2+Math.cos(t*.3)*2+Math.sin((e+t)*.18)*3+Math.sin(e*1.7+t*.8)*Math.cos(t*1.3)*.5)*r}getHeightAt(e,t){return this.getBaseHeightAt(e,t)+this.getCraterHeightOffsetAt(e,t)}getCraterHeightOffsetAt(e,t){let n=0;for(let r of this.craters){let i=Math.hypot(e-r.x,t-r.z);n+=this.calculateCraterOffset(i,r.radius,r.depth)}return n}calculateCraterOffset(e,t,n){let r=t*1.25;if(e>r)return 0;if(e<=t){let r=e/t,i=Math.cos(r*Math.PI*.5);return-n*i*i}let i=(e-t)/(r-t);return n*.18*Math.sin(i*Math.PI)}createTerrain(e){this.material=new oa({color:e,roughness:.9,metalness:.1,flatShading:!0,side:2}),this.mesh=new X(this.geometry,this.material),this.add(this.mesh)}createWireframe(e){this.wireframeGeometry=new Ji(this.geometry),this.wireframeMaterial=new gi({color:e,transparent:!0,opacity:.45}),this.wireframe=new Oi(this.wireframeGeometry,this.wireframeMaterial),this.wireframe.position.y=.015,this.add(this.wireframe)}deformCrater(e,t,n,r){let i=this.worldToLocal(new G(e,0,t)),a={x:i.x,z:i.z,radius:n,depth:r};this.craters.push(a);let o=this.geometry.attributes.position;for(let e=0;e<o.count;e+=1){let t=o.getX(e),i=o.getZ(e),s=Math.hypot(t-a.x,i-a.z),c=this.calculateCraterOffset(s,n,r);c!==0&&o.setY(e,o.getY(e)+c)}o.needsUpdate=!0,this.geometry.computeVertexNormals(),this.geometry.computeBoundingBox(),this.geometry.computeBoundingSphere(),this.refreshWireframe()}refreshWireframe(){if(!this.wireframe)return;let e=this.wireframeGeometry;this.wireframeGeometry=new Ji(this.geometry),this.wireframe.geometry=this.wireframeGeometry,e.dispose()}dispose(){this.geometry.dispose(),this.material.dispose(),this.wireframeGeometry.dispose(),this.wireframeMaterial.dispose(),this.craters.length=0}},vu=class extends Pn{constructor({start:e,end:t,color:n,speed:r=40,length:i=.7,onComplete:a=()=>{}}){super(),this.start=e.clone(),this.end=t.clone(),this.onComplete=a,this.elapsedTime=0,this.completed=!1;let o=this.end.clone().sub(this.start),s=o.length();this.duration=s/r,o.normalize(),this.createBolt(n,i),this.quaternion.setFromUnitVectors(new G(0,1,0),o),this.position.copy(this.start)}createBolt(e,t){let n=new Vi(.015,.015,t,5),r=new qr({color:16777215,toneMapped:!1});this.core=new X(n,r),this.add(this.core);let i=new Vi(.05,.05,t*1.15,6),a=new qr({color:e,transparent:!0,opacity:.65,blending:2,depthWrite:!1,toneMapped:!1});this.glow=new X(i,a),this.add(this.glow)}update(e){this.elapsedTime+=e;let t=Math.min(this.elapsedTime/this.duration,1);return this.position.lerpVectors(this.start,this.end,t),t>=1&&!this.completed?(this.completed=!0,this.onComplete(),!1):!0}dispose(){this.core.geometry.dispose(),this.core.material.dispose(),this.glow.geometry.dispose(),this.glow.material.dispose()}},yu=class{constructor({scene:e,firstArmy:t,secondArmy:n,shootingRange:r=16,getTerrainHeight:i=()=>0}){this.scene=e,this.getTerrainHeight=i,this.flyingSoldiers=[],this.firstArmy=t,this.secondArmy=n,this.shootingRange=r,this.shots=[],this.soldierCombatState=new WeakMap}update(e){this.updateFlyingSoldiers(e),this.updateArmyFire(this.firstArmy,this.secondArmy,e),this.updateArmyFire(this.secondArmy,this.firstArmy,e),this.updateShots(e)}updateArmyFire(e,t,n){let r=e.getLivingSoldiers(),i=t.getLivingSoldiers();if(i.length!==0)for(let t of r){let r=this.getCombatState(t);if(r.fireTimer-=n,r.fireTimer>0)continue;let a=this.findTarget(t,i);if(!a){r.fireTimer=U.randFloat(.2,.6);continue}this.fire(t,a,e.color,r.accuracy),r.fireTimer=U.randFloat(1.1,2.8)}}getCombatState(e){let t=this.soldierCombatState.get(e);return t||(t={fireTimer:U.randFloat(0,2),accuracy:U.randFloat(.8,1)},this.soldierCombatState.set(e,t)),t}findTarget(e,t){let n=e.getWorldPosition(new G),r=[];for(let e of t){let t=e.getWorldPosition(new G),i=n.distanceTo(t);i<=this.shootingRange&&r.push({enemy:e,distance:i})}if(r.length===0)return null;r.sort((e,t)=>e.distance-t.distance);let i=r.slice(0,Math.min(6,r.length));return i[Math.floor(Math.random()*i.length)].enemy}fire(e,t,n,r){let i=e.getWorldPosition(new G);i.y+=.65;let a=t.getWorldPosition(new G);a.y+=.5;let o=i.distanceTo(a),s=U.clamp(o/this.shootingRange,0,1),c=U.lerp(.85,.4,s)*r,l=Math.random()<c,u=a.clone(),d=l?.08:U.lerp(.5,2,s);u.x+=this.randomNormal()*d,u.y+=this.randomNormal()*d*.4,u.z+=this.randomNormal()*d;let f=new vu({start:i,end:u,color:n,speed:U.randFloat(35,55),length:U.randFloat(.5,1),onComplete:()=>{l&&t.isAlive&&t.takeDamage(1)}});this.shots.push(f),this.scene.add(f)}randomNormal(){let e=0;for(let t=0;t<6;t++)e+=Math.random();return e-3}updateShots(e){for(let t=this.shots.length-1;t>=0;t--){let n=this.shots[t];n.update(e)||(this.scene.remove(n),n.dispose(),this.shots.splice(t,1))}}handleTankShot({tank:e,targetPosition:t}){let n=e=>{let t=1-e/4;return{damage:Math.round(20+80*t),damageRatio:t}},r=(e,t)=>{let n=e.x-t.x,r=e.z-t.z;return Math.hypot(n,r)},i=e.getEnemyPlatoons(),a=new Set;for(let o of i){let i=e.getLivingSoldiersInPlatoon(o);for(let e of i){if(a.has(e))continue;let i=r(e.getWorldPosition(new G),t);if(i>4)continue;a.add(e);let{damage:o,damageRatio:s}=n(i);this.damageSoldier(e,o,t,s)}e.getLivingSoldiersInPlatoon(o).length===0&&(o.isAlive=!1)}let o=e.getEnemyTanks(),s=new Set;for(let i of o){if(!i||i===e||i.isAlive===!1||s.has(i))continue;let a=r(i.getWorldPosition(new G),t);if(a>4)continue;s.add(i);let{damage:o}=n(a);i.takeDamage(o)}e.isValidCombatTarget(e.targetUnit)||(e.targetUnit=null,e.targetPlatoon=null,e.targetType=null)}damageSoldier(e,t,n,r){if(e.isAlive===!1)return;let i=!1;typeof e.takeDamage==`function`?(e.takeDamage(t),i=e.isAlive===!1||e.health<=0):typeof e.health==`number`?(e.health-=t,i=e.health<=0):i=t>=50,i&&(e.isAlive=!1,this.launchSoldier(e,n,Math.max(.35,r)))}launchSoldier(e,t,n=1){if(!e||e.userData.isFlying)return;e.userData.isFlying=!0,this.scene.attach(e),e.visible=!0,e.isAlive=!1;let r=e.position.clone().sub(t).setY(0);r.lengthSq()<.001&&r.set(U.randFloat(-1,1),0,U.randFloat(-1,1)),r.normalize();let i=U.randFloat(5,10)*n,a=U.randFloat(6,11)*n,o=r.multiplyScalar(i);o.y=a;let s=new G(U.randFloat(-8,8),U.randFloat(-8,8),U.randFloat(-8,8));this.flyingSoldiers.push({soldier:e,velocity:o,angularVelocity:s,age:0,groundedTime:0})}updateFlyingSoldiers(e){for(let t=this.flyingSoldiers.length-1;t>=0;--t){let n=this.flyingSoldiers[t],{soldier:r,velocity:i,angularVelocity:a}=n;n.age+=e,i.y-=18*e,r.position.addScaledVector(i,e),r.rotation.x+=a.x*e,r.rotation.y+=a.y*e,r.rotation.z+=a.z*e;let o=this.getTerrainHeight(r.position.x,r.position.z)+.2;r.position.y<=o&&(r.position.y=o,Math.abs(i.y)>1?(i.y=Math.abs(i.y)*.25,i.x*=.65,i.z*=.65,a.multiplyScalar(.6)):(i.set(0,0,0),a.set(0,0,0),n.groundedTime+=e)),(n.groundedTime>2||n.age>6)&&(r.visible=!1,r.removeFromParent(),this.flyingSoldiers.splice(t,1))}}},bu=class extends Pn{constructor({color:e=3800852,spawn:t=new G,speed:n=3,maxForce:r=6,fireRange:i=16,fireInterval:a=10,team:o,health:s=500,turretTurnSpeed:c=U.degToRad(10),fireAngleTolerance:l=U.degToRad(3),getEnemyTanks:u=()=>[],onDestroyed:d=()=>{},onFire:f=()=>{},getTerrainHeight:p=()=>0,getObstacles:m=()=>[],getEnemyPlatoons:h=()=>[]}={}){super(),this.collisionRadius=1.1,this.speed=n,this.maxForce=r,this.getTerrainHeight=p,this.getObstacles=m,this.getEnemyPlatoons=h,this.getEnemyTanks=u,this.smokeHealthThreshold=.4,this.smokeTimer=0,this.smokeParticles=[],this.fireRange=i,this.fireInterval=a,this.onFire=f,this.flyingTurret=null,this.turretTurnSpeed=c,this.fireAngleTolerance=l,this.team=o,this.maxHealth=s,this.health=s,this.isAlive=!0,this.onDestroyed=d,this.targetUnit=null,this.targetPlatoon=null,this.targetType=null,this.fireTimer=U.randFloat(0,this.fireInterval),this.velocity=new G,this.bodyMaterial=new oa({color:e,emissive:e,emissiveIntensity:.5,roughness:.75,metalness:.2,flatShading:!0}),this.trackMaterial=new oa({color:1054752,roughness:.9,metalness:.4,flatShading:!0}),this.createHull(),this.createTracks(),this.createTurret(),this.position.copy(t),this.position.y=this.getTerrainHeight(t.x,t.z)+.03,this.setInitialVelocity(),this.alignToTerrain(0,!0)}createHull(){let e=new Bi(1.2,.32,1.55);this.hull=new X(e,this.bodyMaterial),this.hull.position.y=.3,this.add(this.hull)}createTracks(){let e=new Bi(.25,.25,1.8);this.leftTrack=new X(e,this.trackMaterial),this.leftTrack.position.set(-.68,.2,0),this.add(this.leftTrack),this.rightTrack=new X(e,this.trackMaterial),this.rightTrack.position.set(.68,.2,0),this.add(this.rightTrack)}createTurret(){this.turret=new Pn;let e=new X(new Vi(.43,.48,.25,8),this.bodyMaterial);e.position.y=.55,this.turret.add(e);let t=new Bi(.1,.1,1);this.barrel=new X(t,this.bodyMaterial),this.barrel.position.set(0,.58,.65),this.turret.add(this.barrel);let n=new Vi(.18,.18,.1,8);this.hatch=new X(n,this.bodyMaterial),this.hatch.position.y=.73,this.turret.add(this.hatch),this.add(this.turret)}setInitialVelocity(){this.velocity.set(0,0,0)}update(e){if(this.updateSmoke(e),this.updateFlyingTurret(e),!this.isAlive||!this.isAlive)return;this.fireTimer=Math.max(0,this.fireTimer-e),this.isValidCombatTarget(this.targetUnit)||this.selectClosestEnemyTarget();let t=null,n=1/0;if(this.targetUnit){t=this.targetUnit.getWorldPosition(new G),t.y+=.6;let r=t.clone().sub(this.position).setY(0);n=r.length();let i=this.fireRange*.75,a=new G;if(n>i+1){let e=this.speed*U.clamp((n-i)/5,.25,1);a.copy(r).normalize().multiplyScalar(e)}else n<i-2&&a.copy(r).normalize().multiplyScalar(-this.speed*.5);let o=a.sub(this.velocity).clampLength(0,this.maxForce),s=this.avoidObstacles();o.addScaledVector(s,this.maxForce*3),o.clampLength(0,this.maxForce),this.velocity.addScaledVector(o,e),this.velocity.clampLength(0,this.speed)}else this.velocity.multiplyScalar(Math.exp(-6*e));this.position.addScaledVector(this.velocity,e),this.position.y=this.getTerrainHeight(this.position.x,this.position.z)+.03,this.alignToTerrain(e),t&&this.aimTurretAt(t,e)&&n<=this.fireRange&&this.tryFireAt(t,n)}getTerrainNormal(e,t){let n=.4,r=this.getTerrainHeight(e-n,t),i=this.getTerrainHeight(e+n,t),a=this.getTerrainHeight(e,t-n),o=this.getTerrainHeight(e,t+n);return new G(r-i,n*2,a-o).normalize()}alignToTerrain(e,t=!1){let n=this.getTerrainNormal(this.position.x,this.position.z),r=this.velocity.clone().setY(0);if(r.lengthSq()<.001)return;r.normalize().projectOnPlane(n).normalize();let i=new G().crossVectors(n,r).normalize();r.crossVectors(i,n).normalize();let a=new on().makeBasis(i,n,r),o=new Lt().setFromRotationMatrix(a);if(t){this.quaternion.copy(o);return}let s=1-Math.exp(-4*e);this.quaternion.slerp(o,s)}aimTurretAt(e,t){let n=e.clone().sub(this.position).setY(0),r=this.quaternion.clone().invert(),i=n.applyQuaternion(r),a=Math.atan2(i.x,i.z),o=this.turret.rotation.y,s=Math.atan2(Math.sin(a-o),Math.cos(a-o)),c=this.turretTurnSpeed*t,l=U.clamp(s,-c,c),u=o+l;return this.turret.rotation.y=Math.atan2(Math.sin(u),Math.cos(u)),Math.abs(s-l)<=this.fireAngleTolerance}avoidObstacles(){let e=this.getObstacles(),t=new G;if(this.velocity.lengthSq()<.001)return t;let n=this.velocity.clone().setY(0).normalize(),r=this.position.clone().addScaledVector(n,2.5);for(let i of e){if(i===this||i.isAlive===!1)continue;let e=i.getWorldPosition(new G),a=i.collisionRadius??.25,o=this.collisionRadius+a+.5,s=new G(this.position.x-e.x,0,this.position.z-e.z),c=new G(r.x-e.x,0,r.z-e.z),l=s.length(),u=c.length(),d=Math.min(l,u);if(d>=o)continue;let f=l<u?s:c;f.lengthSq()<.001&&f.set(-n.z,0,n.x),f.normalize();let p=1-d/o;t.addScaledVector(f,p)}return t.clampLength(0,1)}tryFireAt(e,t){if(this.fireTimer>0||t>this.fireRange||!this.isValidCombatTarget(this.targetUnit))return;this.fireTimer=this.fireInterval,this.updateWorldMatrix(!0,!0);let n=this.barrel.localToWorld(new G(0,0,.5)),r=e.clone(),i=this.targetUnit,a=this.targetType,o=this.targetPlatoon;this.createTracer(n,r),window.setTimeout(()=>{this.createExplosion(r),this.onFire({tank:this,targetUnit:i,targetType:a,targetPlatoon:o,origin:n.clone(),targetPosition:r.clone()})},80)}createTracer(e,t){if(!this.parent)return;let n=this.parent,r=n.worldToLocal(e.clone()),i=n.worldToLocal(t.clone()),a=new Ir().setFromPoints([r,i]),o=new gi({color:this.bodyMaterial.color,transparent:!0,opacity:1,blending:2,depthWrite:!1}),s=new wi(a,o);n.add(s),window.setTimeout(()=>{s.removeFromParent(),a.dispose(),o.dispose()},80)}createExplosion(e){if(!this.parent)return;let t=this.parent,n=new Pn;n.position.copy(t.worldToLocal(e.clone())),n.position.y+=.4;let r=new qi(.35,10,10),i=new qr({color:16763989,transparent:!0,opacity:1,blending:2,depthWrite:!1}),a=new X(r,i);n.add(a);let o=new qi(.5,10,10),s=new qr({color:16729088,transparent:!0,opacity:.8,blending:2,depthWrite:!1,wireframe:!0}),c=new X(o,s);n.add(c);let l=new za(16737809,12,12,2);l.position.y=.5,n.add(l);let u=new Float32Array(96),d=[];for(let e=0;e<32;e+=1){let e=new G(U.randFloat(-1,1),U.randFloat(.2,1.3),U.randFloat(-1,1)).normalize().multiplyScalar(U.randFloat(3,9));d.push(e)}let f=new Ir;f.setAttribute(`position`,new Sr(u,3));let p=new ki({color:16755251,size:.22,transparent:!0,opacity:1,blending:2,depthWrite:!1}),m=new Pi(f,p);n.add(m),t.add(n);let h=performance.now(),g=h,_=e=>{let t=e-h,u=Math.min((e-g)/1e3,.05);g=e;let m=U.clamp(t/650,0,1);a.scale.setScalar(.5+m*4),c.scale.setScalar(.5+m*7),i.opacity=1-m,s.opacity=(1-m)*.8,p.opacity=1-m,l.intensity=12*(1-m);let v=f.attributes.position.array;for(let e=0;e<32;e+=1){let t=d[e];t.y-=8*u,v[e*3]+=t.x*u,v[e*3+1]+=t.y*u,v[e*3+2]+=t.z*u}if(f.attributes.position.needsUpdate=!0,m<1){requestAnimationFrame(_);return}n.removeFromParent(),r.dispose(),i.dispose(),o.dispose(),s.dispose(),f.dispose(),p.dispose()};requestAnimationFrame(_)}getLivingSoldiersInPlatoon(e){return e?(e.getLivingSoldiers?.()??e.soldiers??e.members??e.children??[]).filter(e=>e&&e.isAlive!==!1&&e.visible!==!1&&typeof e.getWorldPosition==`function`):[]}isValidCombatTarget(e){return!!(e&&e!==this&&e.isAlive!==!1&&e.visible!==!1&&e.parent)}selectClosestEnemyTarget(){let e=this.getWorldPosition(new G),t=null,n=1/0;for(let r of this.getEnemyPlatoons()){let i=this.getLivingSoldiersInPlatoon(r);if(i.length===0)continue;let a=new G;for(let e of i)a.add(e.getWorldPosition(new G));a.divideScalar(i.length);let o=e.distanceToSquared(a);if(o>=n)continue;let s=null,c=1/0;for(let t of i){let n=t.getWorldPosition(new G),r=e.distanceToSquared(n);r<c&&(c=r,s=t)}n=o,t={unit:s,platoon:r,type:`soldier`}}for(let r of this.getEnemyTanks()){if(!this.isValidCombatTarget(r))continue;let i=r.getWorldPosition(new G),a=e.distanceToSquared(i);a<n&&(n=a,t={unit:r,platoon:null,type:`tank`})}if(!t){this.targetUnit=null,this.targetPlatoon=null,this.targetType=null;return}this.targetUnit=t.unit,this.targetPlatoon=t.platoon,this.targetType=t.type}takeDamage(e){if(!this.isAlive)return;this.health=Math.max(0,this.health-e);let t=this.bodyMaterial.emissive.getHex();this.bodyMaterial.emissive.setHex(16777215),window.setTimeout(()=>{this.isAlive&&this.bodyMaterial.emissive.setHex(t)},80),this.health===0&&this.destroy()}destroy(){if(!this.isAlive)return;this.isAlive=!1,this.health=0,this.velocity.set(0,0,0);let e=this.getWorldPosition(new G);e.y+=.5,this.createExplosion(e),this.launchTurret(),this.bodyMaterial.color.multiplyScalar(.2),this.bodyMaterial.emissive.setHex(1115392),this.bodyMaterial.emissiveIntensity=.15,this.trackMaterial.color.multiplyScalar(.35),this.targetUnit=null,this.targetPlatoon=null,this.targetType=null,this.onDestroyed(this)}dispose(){let e=new Set,t=new Set;this.clearSmoke(),this.clearFlyingTurret(),this.traverse(n=>{if(n.geometry&&e.add(n.geometry),n.material){let e=Array.isArray(n.material)?n.material:[n.material];for(let n of e)t.add(n)}});for(let t of e)t.dispose();for(let e of t)e.dispose()}updateSmoke(e){let t=this.health/this.maxHealth;if(!this.isAlive||t<=this.smokeHealthThreshold&&this.health>0){if(this.smokeTimer-=e,this.smokeTimer<=0){this.createSmokeParticle();let e=1-t;this.smokeTimer=U.lerp(.3,.08,e)}}else this.smokeTimer=0;for(let t=this.smokeParticles.length-1;t>=0;--t){let n=this.smokeParticles[t];n.age+=e;let r=n.age/n.lifetime;n.mesh.position.addScaledVector(n.velocity,e),n.velocity.x+=Math.sin(n.age*3+n.seed)*.15*e,n.velocity.z+=Math.cos(n.age*2+n.seed)*.15*e,n.mesh.scale.setScalar(1+r*2.5),n.material.opacity=.5*(1-r),!(r<1)&&(n.mesh.removeFromParent(),n.geometry.dispose(),n.material.dispose(),this.smokeParticles.splice(t,1))}}createSmokeParticle(){if(!this.parent)return;this.updateWorldMatrix(!0,!0);let e=this.localToWorld(new G(U.randFloat(-.2,.2),.75,-.6)),t=this.parent,n=t.worldToLocal(e),r=new Wi(U.randFloat(.15,.28),0),i=new qr({color:2502970,transparent:!0,opacity:.5,depthWrite:!1}),a=new X(r,i);a.position.copy(n),a.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),t.add(a),this.smokeParticles.push({mesh:a,geometry:r,material:i,velocity:new G(U.randFloat(-.2,.2),U.randFloat(.8,1.4),U.randFloat(-.2,.2)),lifetime:U.randFloat(1.5,2.5),seed:Math.random()*Math.PI*2,age:0})}clearSmoke(){for(let e of this.smokeParticles)e.mesh.removeFromParent(),e.geometry.dispose(),e.material.dispose();this.smokeParticles.length=0}launchTurret(){if(!this.turret||!this.parent||this.flyingTurret)return;let e=this.parent;this.updateWorldMatrix(!0,!0),this.turret.traverse(e=>{e.material&&(Array.isArray(e.material)?e.material=e.material.map(e=>e.clone()):e.material=e.material.clone())}),e.attach(this.turret);let t=new G(U.randFloat(-1,1),0,U.randFloat(-1,1)).normalize().multiplyScalar(U.randFloat(5,9));t.y=U.randFloat(9,14),t.y=U.randFloat(6,10),this.flyingTurret={object:this.turret,velocity:t,angularVelocity:new G(U.randFloat(-7,7),U.randFloat(-7,7),U.randFloat(-7,7)),age:0,settled:!1},this.turret=null}updateFlyingTurret(e){if(!this.flyingTurret||this.flyingTurret.settled)return;let{object:t,velocity:n,angularVelocity:r}=this.flyingTurret;this.flyingTurret.age+=e,n.y-=16*e,t.position.addScaledVector(n,e),t.rotation.x+=r.x*e,t.rotation.y+=r.y*e,t.rotation.z+=r.z*e;let i=this.getTerrainHeight(t.position.x,t.position.z)+.05;if(!(n.y>=0)&&!(t.position.y>i)){if(t.position.y=i,Math.abs(n.y)>1.5){n.y=Math.abs(n.y)*.3,n.x*=.65,n.z*=.65,r.multiplyScalar(.6);return}n.set(0,0,0),r.set(0,0,0),this.flyingTurret.settled=!0}}clearFlyingTurret(){if(!this.flyingTurret)return;let e=this.flyingTurret.object;e.traverse(e=>{if(e.geometry&&e.geometry.dispose(),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e.dispose()}}),e.removeFromParent(),this.flyingTurret=null}},xu=class{constructor({scene:e,terrain:t,centre:n=new G,strikeRadius:r=15,minimumInterval:i=2,maximumInterval:a=5}){this.scene=e,this.terrain=t,this.centre=n,this.strikeRadius=r,this.minimumInterval=i,this.maximumInterval=a,this.effects=[],this.resetTimer()}resetTimer(){this.strikeTimer=U.randFloat(this.minimumInterval,this.maximumInterval)}update(e){this.strikeTimer-=e,this.strikeTimer<=0&&(this.createStrike(),this.resetTimer()),this.updateEffects(e)}createStrike(){let e=Math.random()*Math.PI*2,t=this.strikeRadius*Math.sqrt(Math.random()),n=this.centre.x+Math.cos(e)*t,r=this.centre.z+Math.sin(e)*t,i=this.terrain.getHeightAt(n,r),a=U.randFloat(2.5,4),o=U.randFloat(.8,1.8);this.terrain.deformCrater(n,r,a,o),this.createExplosion(new G(n,i+.2,r),a)}createExplosion(e,t){let n=new Pn;n.position.copy(e);let r=new qi(.5,12,12),i=new qr({color:16763972,transparent:!0,opacity:1,blending:2,depthWrite:!1}),a=new X(r,i);a.position.y=.5,n.add(a);let o=new Ki(.45,.55,32),s=new qr({color:16737792,transparent:!0,opacity:.9,blending:2,depthWrite:!1,side:2}),c=new X(o,s);c.rotation.x=-Math.PI/2,c.position.y=.1,n.add(c);let l=new za(16733440,30,25,2);l.position.y=2,n.add(l);let u=new Float32Array(240),d=[];for(let e=0;e<80;e+=1){let e=new G(U.randFloat(-1,1),U.randFloat(.2,1.2),U.randFloat(-1,1)).normalize().multiplyScalar(U.randFloat(5,14));d.push(e)}let f=new Ir;f.setAttribute(`position`,new Sr(u,3));let p=new ki({color:16755234,size:.25,transparent:!0,opacity:1,blending:2,depthWrite:!1}),m=new Pi(f,p);n.add(m);let h=new Wi(.4,1),g=[];for(let e=0;e<10;e+=1){let t=new qr({color:e%2==0?16724736:16755200,transparent:!0,opacity:.8,blending:2,depthWrite:!1}),r=new X(h,t),i=new G(U.randFloat(-1.5,1.5),0,U.randFloat(-1.5,1.5));r.position.copy(i),n.add(r),g.push({mesh:r,material:t,basePosition:i,phase:Math.random()})}this.scene.add(n),this.effects.push({group:n,flash:a,flashGeometry:r,flashMaterial:i,shockwave:c,shockwaveGeometry:o,shockwaveMaterial:s,light:l,sparks:m,sparkGeometry:f,sparkMaterial:p,sparkVelocities:d,fireGeometry:h,firePuffs:g,blastRadius:t,age:0,lifetime:7,fireLifetime:6})}updateEffects(e){for(let t=this.effects.length-1;t>=0;--t){let n=this.effects[t];n.age+=e;let r=U.clamp(n.age/.7,0,1);n.flash.scale.setScalar(.3+r*n.blastRadius*1.8),n.flashMaterial.opacity=1-r,n.shockwave.scale.setScalar(.2+r*n.blastRadius*2.5),n.shockwaveMaterial.opacity=.9*(1-r),n.light.intensity=30*(1-r);let i=n.sparkGeometry.attributes.position.array;for(let t=0;t<n.sparkVelocities.length;t+=1){let r=n.sparkVelocities[t];r.y-=12*e,i[t*3]+=r.x*e,i[t*3+1]+=r.y*e,i[t*3+2]+=r.z*e}n.sparkGeometry.attributes.position.needsUpdate=!0,n.sparkMaterial.opacity=Math.max(0,1-n.age/2);let a=U.clamp((n.fireLifetime-n.age)/1.5,0,1);for(let e of n.firePuffs){let t=(n.age*.8+e.phase)%1;e.mesh.position.set(e.basePosition.x+Math.sin(n.age*3+e.phase*8)*.15,.2+t*2.5,e.basePosition.z+Math.cos(n.age*2+e.phase*8)*.15),e.mesh.scale.setScalar(.5+t*1.5),e.material.opacity=(1-t)*.8*a}n.age<n.lifetime||(this.disposeEffect(n),this.effects.splice(t,1))}}disposeEffect(e){e.group.removeFromParent(),e.flashGeometry.dispose(),e.flashMaterial.dispose(),e.shockwaveGeometry.dispose(),e.shockwaveMaterial.dispose(),e.sparkGeometry.dispose(),e.sparkMaterial.dispose(),e.fireGeometry.dispose();for(let t of e.firePuffs)t.material.dispose()}dispose(){for(let e of this.effects)this.disposeEffect(e);this.effects.length=0}},Su=class{constructor({scene:e,mapRadius:t=70,minimumInterval:n=4,maximumInterval:r=10,maximumAircraft:i=3}){this.scene=e,this.mapRadius=t,this.minimumInterval=n,this.maximumInterval=r,this.maximumAircraft=i,this.aircraft=[],this.spawnTimer=1}update(e){this.spawnTimer-=e,this.spawnTimer<=0&&this.aircraft.length<this.maximumAircraft&&(this.spawnAircraft(),this.resetSpawnTimer());for(let t=this.aircraft.length-1;t>=0;--t){let n=this.aircraft[t];n.age+=e,n.group.position.addScaledVector(n.direction,n.speed*e),n.group.rotation.z=Math.sin(n.age*1.5+n.bankPhase)*.08,this.updateContrails(n),!(Math.hypot(n.group.position.x,n.group.position.z)<this.mapRadius*1.25&&n.age<20)&&(this.removeAircraft(n),this.aircraft.splice(t,1))}}resetSpawnTimer(){this.spawnTimer=U.randFloat(this.minimumInterval,this.maximumInterval)}spawnAircraft(){let e=Math.random()*Math.PI*2,t=new G(Math.cos(e),0,Math.sin(e)).normalize(),n=new G(-t.z,0,t.x),r=t.clone().multiplyScalar(-this.mapRadius);r.addScaledVector(n,U.randFloat(-25,25)),r.y=U.randFloat(4,8);let i=Math.random()>.5?2639452:3490125,a=this.createAircraftModel(i),o=U.randFloat(.8,1.35);a.scale.setScalar(o),a.position.copy(r),a.rotation.y=Math.atan2(t.x,t.z),this.scene.add(a);let s={group:a,direction:t,speed:U.randFloat(12,22),age:0,bankPhase:Math.random()*Math.PI*2,leftTrail:this.createContrail(),rightTrail:this.createContrail()};this.aircraft.push(s)}createAircraftModel(e){let t=new Pn,n=new oa({color:e,emissive:1521740,emissiveIntensity:.6,roughness:.55,metalness:.65,flatShading:!0}),r=new oa({color:725272,emissive:463645,emissiveIntensity:.4,roughness:.7,metalness:.7,flatShading:!0}),i=new X(new Bi(.42,.34,2.5),n);t.add(i);let a=new X(new Hi(.28,.8,6),n);a.rotation.x=Math.PI/2,a.position.z=1.62,t.add(a);let o=new X(new Bi(.32,.22,.65),r);o.position.set(0,.25,.55),t.add(o);let s=new X(new Bi(3.3,.09,.75),n);s.position.z=-.1,t.add(s);let c=new X(new Bi(1.25,.08,.42),n);c.position.z=-1,t.add(c);let l=new X(new Bi(.1,.65,.5),n);l.position.set(0,.32,-1),t.add(l);let u=new X(new qi(.08,6,6),new qr({color:16719920}));u.position.set(-1.7,0,-.1),t.add(u);let d=new X(new qi(.08,6,6),new qr({color:2162560}));return d.position.set(1.7,0,-.1),t.add(d),t}createContrail(){let e=new Float32Array(105),t=new Ir;t.setAttribute(`position`,new Sr(e,3)),t.setDrawRange(0,0);let n=new gi({color:9291735,transparent:!0,opacity:.2,blending:2,depthWrite:!1}),r=new wi(t,n);return r.frustumCulled=!1,this.scene.add(r),{line:r,geometry:t,material:n,positions:e,points:[],maximumPoints:35}}updateContrails(e){e.group.updateWorldMatrix(!0,!0);let t=e.group.localToWorld(new G(-.75,0,-1.1)),n=e.group.localToWorld(new G(.75,0,-1.1));this.addContrailPoint(e.leftTrail,t),this.addContrailPoint(e.rightTrail,n)}addContrailPoint(e,t){e.points.unshift(t),e.points.length>e.maximumPoints&&e.points.pop();for(let t=0;t<e.points.length;t+=1){let n=e.points[t];e.positions[t*3]=n.x,e.positions[t*3+1]=n.y,e.positions[t*3+2]=n.z}e.geometry.attributes.position.needsUpdate=!0,e.geometry.setDrawRange(0,e.points.length)}removeAircraft(e){e.group.removeFromParent(),this.disposeObject(e.group),this.disposeContrail(e.leftTrail),this.disposeContrail(e.rightTrail)}disposeContrail(e){e.line.removeFromParent(),e.geometry.dispose(),e.material.dispose()}disposeObject(e){let t=new Set,n=new Set;e.traverse(e=>{if(e.geometry&&t.add(e.geometry),e.material){let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)n.add(e)}});for(let e of t)e.dispose();for(let e of n)e.dispose()}dispose(){for(let e of this.aircraft)this.removeAircraft(e);this.aircraft.length=0}};function Cu(e){"@babel/helpers - typeof";return Cu=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Cu(e)}function wu(e,t){if(Cu(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(Cu(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Tu(e){var t=wu(e,`string`);return Cu(t)==`symbol`?t:t+``}function Eu(e,t,n){return(t=Tu(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Du={width:window.innerWidth,height:window.innerHeight,pixelRatio:window.devicePixelRatio},Ou=class{constructor(e){Eu(this,`ambientLight`,void 0),Eu(this,`directionalLight`,void 0),Eu(this,`terrain`,void 0),Eu(this,`armies`,void 0),Eu(this,`battle`,void 0),Eu(this,`composer`,void 0),Eu(this,`renderPass`,void 0),Eu(this,`bloomPass`,void 0),Eu(this,`crtPass`,void 0),Eu(this,`outputPass`,void 0),this.canvas=e,this.clock=new co,this.render=this.render.bind(this),this.onResize=this.onResize.bind(this),this.scene=new Un,this.scene.background=new J(132881),this.scene.fog=new Hn(132881,20,55),this.setCamera(),this.setRenderer(),this.setControls(),this.setLights(),this.setTerrain(),this.setAircraft(),this.setArtillery(),this.setTanks(),this.setArmies(),this.setPostProcessing(),this.setResize(),this.render()}setCamera(){this.camera=new La(55,Du.width/Du.height,.1,100),this.camera.position.set(0,22,18),this.camera.lookAt(0,0,0),this.scene.add(this.camera)}setRenderer(){this.renderer=new kl({canvas:this.canvas,antialias:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(Du.pixelRatio,2)),this.renderer.setSize(Du.width,Du.height)}setControls(){this.controls=new zl(this.camera,this.canvas),this.controls.target.set(0,0,0),this.controls.enableDamping=!0,this.controls.dampingFactor=.05,this.controls.autoRotate=!0,this.controls.autoRotateSpeed=.4,this.controls.maxPolarAngle=Math.PI/2.1,this.controls.minDistance=8,this.controls.maxDistance=50,this.controls.update()}setPostProcessing(){let e=Math.min(Du.pixelRatio,2);this.composer=new ou(this.renderer),this.composer.setPixelRatio(e),this.composer.setSize(Du.width,Du.height),this.renderPass=new su(this.scene,this.camera),this.composer.addPass(this.renderPass),this.bloomPass=new lu(new W(Du.width,Du.height),1.1,.55,.2),this.composer.addPass(this.bloomPass),this.crtPass=new ru({uniforms:{tDiffuse:{value:null},uTime:{value:0},uResolution:{value:new W(Du.width*e,Du.height*e)},uRgbOffset:{value:.0025},uCurvature:{value:.08},uScanlineIntensity:{value:.16},uNoiseIntensity:{value:.035},uVignetteIntensity:{value:.45},uPhosphorIntensity:{value:.28}},vertexShader:fu,fragmentShader:pu}),this.composer.addPass(this.crtPass),this.outputPass=new du,this.composer.addPass(this.outputPass)}setLights(){this.ambientLight=new Ua(4814762,1.5),this.scene.add(this.ambientLight),this.directionalLight=new Ha(8965375,3),this.directionalLight.position.set(-10,20,5),this.scene.add(this.directionalLight)}setTerrain(){this.terrain=new _u({size:100,segments:120,terrainColor:398374,wireframeColor:3194069}),this.scene.add(this.terrain)}setAircraft(){this.aircraftManager=new Su({scene:this.scene,mapRadius:70,minimumInterval:4,maximumInterval:10,maximumAircraft:3})}setArtillery(){this.artillery=new xu({scene:this.scene,terrain:this.terrain,centre:new G(0,0,0),strikeRadius:15,minimumInterval:2,maximumInterval:5})}setArmies(){let e=this.terrain.getHeightAt.bind(this.terrain),t=()=>this.tanks??[],n=new gu({platoonCount:8,soldiersPerPlatoon:16,spawnX:-20,color:3800852,maxReinforcements:2e3,getTerrainHeight:e,getObstacles:t}),r=new gu({platoonCount:8,soldiersPerPlatoon:16,spawnX:20,color:16724047,maxReinforcements:2e3,getTerrainHeight:e,getObstacles:t});this.armies=[n,r];for(let e of this.armies)this.scene.add(e);console.log(`Green soldiers:`,n.getLivingSoldiers().length),console.log(`Red soldiers:`,r.getLivingSoldiers().length),this.battle=new yu({scene:this.scene,firstArmy:n,secondArmy:r,shootingRange:16,getTerrainHeight:this.terrain.getHeightAt.bind(this.terrain)})}render(){let e=Math.min(this.clock.getDelta(),.05);for(let t of this.armies)t.update(e);for(let t of this.tanks)t.update(e);this.artillery.update(e),this.aircraftManager.update(e),this.battle.update(e),this.controls.update(),this.crtPass.uniforms.uTime.value+=e,this.composer.render(e),requestAnimationFrame(this.render)}setResize(){window.addEventListener(`resize`,this.onResize)}onResize(){Du.width=window.innerWidth,Du.height=window.innerHeight,Du.pixelRatio=window.devicePixelRatio;let e=Math.min(Du.pixelRatio,2);this.camera.aspect=Du.width/Du.height,this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(e),this.renderer.setSize(Du.width,Du.height),this.composer.setPixelRatio(e),this.composer.setSize(Du.width,Du.height),this.crtPass.uniforms.uResolution.value.set(Du.width*e,Du.height*e)}setTanks(){this.tanks=[],this.tankWreckLifetime=999999999,this.tanksPerTeam=2,this.tankRespawnDelay=1e3;for(let e=0;e<this.tanksPerTeam;e+=1)this.spawnTank(`green`),this.spawnTank(`red`)}spawnTank(e){let t=this.terrain.getHeightAt.bind(this.terrain),n=()=>{let e=this.armies?.flatMap(e=>e.getLivingSoldiers())??[],t=this.tanks?.filter(e=>e.isAlive)??[];return[...e,...t]},r=e===`green`,i=r?3800852:16724047,a=r?-24:24,o=r?-5:5,s=new G(a+U.randFloat(-2,2),0,o+U.randFloat(-6,6)),c=+!!r,l=r?`red`:`green`,u=new bu({team:e,color:i,health:500,spawn:s,speed:.6,maxForce:2,getTerrainHeight:t,getObstacles:n,getEnemyPlatoons:()=>this.armies?.[c]?.platoons??[],getEnemyTanks:()=>this.tanks?.filter(e=>e.team===l&&e.isAlive)??[],onFire:e=>{this.battle?.handleTankShot(e)},onDestroyed:e=>{this.handleTankDestroyed(e)}});return this.tanks.push(u),this.scene.add(u),u}handleTankDestroyed(e){let t=e.team;window.setTimeout(()=>{this.tanks.filter(e=>e.team===t&&e.isAlive).length<this.tanksPerTeam&&this.spawnTank(t)},this.tankRespawnDelay),window.setTimeout(()=>{this.tanks=this.tanks.filter(t=>t!==e),e.removeFromParent(),e.dispose()},this.tankWreckLifetime)}};document.addEventListener(`DOMContentLoaded`,()=>{}),window.addEventListener(`load`,()=>{let e=document.querySelector(`#canvas`);if(e)return new Ou(e)});